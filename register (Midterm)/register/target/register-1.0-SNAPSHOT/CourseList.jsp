    ...
    <div class="row w-100">
        <form class="form-inline" action="course-list" method="post">
            <div class="form-group mx-4">
                ...
                <select name="semester" id="semester" class="px-4">  <%-- ส่ง Semester ไปให้ที่ Servlet dopost --%>
            ...
            <form action="register" method="post">
                ...
                <c:forEach items="${subjects}" var="subject" varStatus="vs">
                    <div class="row bg-transparent">
                        ...
                        <div class="col-1">
                            <input type="checkbox" name="registeredSubjects" value="${subject.subjectId}"> <%-- registeredSubject เป็น multiplevalue --%>
                        </div>
                    </div>
                </c:forEach>
                <hr>
...
<%--
Servlet ที่จะใช้ process การลงทะเบียน จะได้รับ Request Parameter ชื่ออะไรบ้าง
คำตอบ : 1. hidden field ที่ชื่อ "semester"
        2. "registeredSubjects" (มีวิชาอะไรบ้าง)
 --%>